...
DO $$ DECLARE f record; BEGIN
  ...
  ('ensure_profile','update_user_handle','find_or_create_match','find_or_create_explore_match','find_explore_match','join_room_by_id','leave_match_queue','send_room_message','send_raid_invite','respond_to_raid_invite','reroll_shared_quest','start_solo_mission','accept_assignment','accept_room_mission','get_active_mission','cancel_active_mission','attach_mission_proof','complete_assigned_mission','complete_mission','acknowledge_proof_cleanup','add_squad_friend','react_to_mission','report_content','get_explorer_public_profile','get_friends_leaderboard','get_my_blocked_users','get_random_hidden_gem','submit_hidden_gem','submit_quest_suggestion','block_user','unblock_user','admin_approve_gem','admin_approve_quest','admin_ban_user','admin_delete_chat_message','admin_delete_feed_post','admin_get_all_gems','admin_get_pending_gem_count','admin_get_pending_gems','admin_get_pending_quests','admin_get_reports','admin_reject_gem','admin_reject_quest','admin_resolve_report','admin_unban_user','admin_update_gem') LOOP
